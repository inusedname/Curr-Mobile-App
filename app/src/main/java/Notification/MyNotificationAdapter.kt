...
class MyNotificationAdapter (private  val newList:ArrayList<NewNotification>) : RecyclerView.Adapter<MyNotificationAdapter.MyViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView=LayoutInflater.from(parent.context).inflate(R.layout.list_notification,parent,false)
